...
const missions: IMissionType = {
  ...
  5: {
    ...
    version2: {
      subtitle: `예쁜 쓰레기 지르기 🪀`,
      description: `유저님을 위한 날이에요! 작고 쓸모 없는 예쁜 쓰레기 하나 지르고 오세요! 대신 딱 5만원 이하로만 지르기!`,
      type: "photo",
  ...
  7: {
    ...
    version2: {
      subtitle: `찐맛집 예약하기 📞`,
      description: `유저님, 평소 가고 싶었던 맛집이 있다면 지금 바로 예약하세요! 대신 진짜 맛있는 거 드시고 오셔야 해요!`,
      type: "photo",
...
\n\n잘 추는지 아닌지는 전혀 상관없어요. 내 몸을 마음껏 움직이며 손끝 발끝을 다 사용해 내 안의 감정을 표현하는 것이 중요해요. 말로는 하기 힘들었던 내 마음을 흐르는 대로 꺼내 놓아보세요.\n\n\n\n슬픈 노래도 좋고 신나는 노래도 좋아요. 아무도 없는 방 안에서 혼자 마음 가는 대로 몸을 움직여 보세요. 평소 쓰지 않던 근육의 움직임을 느끼며 땀이 날 정도로 춤을 추다 보면, 어느새 마음도 한결 후련해질 거예요.`,
  ...
  10: {
    version1: {
      ...
      description: `유저님을 위한 저녁 식사를 차려보세요. 기름지고 맛있는 음식이라면 완벽합니다.`,
      type: "photo",
  ...
  11: {
    ...
    version3: {
      ...
      description: `기분 좋은 웃음을 머금고 사진 한 장 남겨보세요! 나중의 유저님이 그리워할 만큼 멋진 얼굴로요!`,
      type: "photo",
  ...
  12: {
    ...
    version2: {
      subtitle: `하늘 사진 찍어보기 🌤`,
      description: `유저님, 오늘 하늘은 어떤 색인가요?잠시 고개를 들고 하늘 사진 한 장 찍어보세요!`,
      type: "both",
