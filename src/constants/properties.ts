...
export const introduceMindText = [
  `좋아요!\n그럼 지금부터 유저님의 마음을 알아보기 위한 질문을 드릴게요.`,
  `답변에 따라,\n유저님의 마음을 본 뜬 씨앗이\n만들어집니다.`,
  `앞으로 14일간, \n저희가 드리는 매일의 작은 할 일을 하며 씨앗을 돌봐주세요.`,
  `씨앗이 움을 틔울수록, 유저님의 마음도 점점 편해지실 거예요.`,
];
...
export const MindTestResultText: { [key: string]: string } = {
  ...
  serious: `유저님의 우울증 정도는 심각한 상태예요. 일상 생활이 어려울 정도의 부정적인 기분이 자주 드실 수 있어요. 심한 경우 전문가의 상담과 도움이 필요합니다.\n\n이렇게 마음이 어렵고 답답할수록, 무엇보다 중요한 것은 자신이라는 사실을 잊기 쉬운데요. 전부 다 괜찮아질 거라고, 스스로에게 말해주세요. 저희도 그렇게 믿고 있답니다 🙏🏻`,
  attention: `유저님의 우울증 정도는 주의가 필요한 상태예요. 평소엔 괜찮은 것 같다가도 종종 마음이 답답해지고 가라앉는 느낌이 드실 수 있어요.\n\n그렇지만 다행히 아주 힘든 시기는 지났다고 할 수 있어요. 아직 말끔한 마음은 아니지만, 조금씩 일상으로 돌아오는 과정이라고 생각하셔도 좋아요 💪🏼`,
  moderate: `유저님의 우울증 정도는 보통 상태예요. 일상 생활을 하면서 흔히 겪을 수 있는, 일반적인 수준의 스트레스를 받고 계시다고 할 수 있어요.\n\n이따금 이유 모를 한숨이 입 밖으로 터져나올 수 있지만 너무 염려하시지 않으셔도 돼요. 이미 충분히 마음을 잘 다스리고 계시고, 이대로 조금씩만 더 노력하면 금방 말끔해지실 거예요 😌`,
  good: `유저님의 우울증 정도는 정상 상태예요. 이제 완전히 이별을 마무리하고 새로 시작할 준비가 되셨군요!이런 탄탄한 마음이라면 당장 무엇이든 해볼 수 있겠어요.\n\n지금 이 마음 그대로 일상의 새로움을 더해주시면서 여정을 이어나가 주세요. 저희도 지금처럼 곁에서 함께할게요 🌱`,
};
...
export const NoticeTexts: { [key: number]: { [key: string]: string } } = {
  1: {
    Q: `‘새로’의 의미는 무엇인가요?`,
    A: `안녕하세요, 저희는 유저님의 새로운 시작을 돕는 팀 새로입니다.\n\n새로를 준비하면서 저희가 꿈꿔왔던 것은 한 가지였어요. 이별이라는 상처를 잘 소화할 수 있도록 도와드리는 것.\n\n사랑했고 사랑받었던 좋은 기억을 부정하지 않고\n다음 연애는 더 잘할 수 있는 기회를 만들어 드리고 싶었어요.\n\n저희 팀원들도 살면서 몇 번의 이별을 경험했고\n덕분에 이별이 얼마나 어렵고 복잡한 일인지 잘 알고 있습니다.\n\n지금 유저님께서 느끼시는 아픔을 감히 전부 안다고 말할 수 없겠지요.\n\n그럼에도 그 아픔을 가늠하고 나누고 싶은 마음이 이 서비스 곳곳에 묻어있음을 알아주시면 더 바랄 게 없겠습니다. \n\n그럼 지금부터 새로와 함께 마음의 꽃을 활짝 피워내시길 바라요. 저희가 최선을 다해 도와드리겠습니다\n\n\n앞으로 잘 부탁드려요\n감사드립니다\n\n\n팀 새로 드림`,
  },
};
...
export const notificationTexts = {
  missionAfterNoti: [
    ...
    },
    {
      ...
      body: `유저님이 힘차게 아침을 맞이하도록 새로가 응원할게요!`,
    },
    {
      title: "푹 주무셨어요?",
    ...
    },
    {
      ...
      body: `화창하든 우중충하든, 유저님의 마음만은 밝게 하루를 맞이할 거예요.`,
    },
    {
      title: `유저님, 새로 할 일이 도착했어요.`,
  ...
  missionDidnotNoti: [
    {
      ...
      body: `하지만 새로미는 유저님 만큼 강해요. 새로미가 버틸 동안 할 일을 완료해주세요!`,
    },
    {
      title: `유저님! 새로미 보고 싶지 않으세요?,`,
