...
export const notificationTexts = {
  ...
  nightNoti: [
    {
      title: "어떤 하루 보내셨어요?",
      body: `바쁜 하루를 보낸 ${nickname}님을 새로미가 기다리고 있어요!`,
    },
    {
      title: `${nickname}님! 새로미가 시들고 있어요.`,
      body: `화분에 물을 주러 같이 가볼까요?`,
    },
    {
      title: "물 주기까지 2시간 남았어요.",
      body: `할 일을 완료해서 ${nickname}님만의 꽃을 피워보아요.`,
    },
  ],
  cautionNoti: [
    {
      title: "할 일 인증 시간이 지났어요.",
      body: `하지만 새로미는 ${nickname}님 만큼 강하답니다. 새로미가 버틸 동안 할 일을 완료해주세요!`,
    },
    {
      title: `${nickname}님! 새로미 보고 싶지 않으세요?,`,
      body: `새로미가 기다리고 있으니 오늘은 꼭 다시 찾아주세요.`,
    },
    {
      title: "새로미가 시들고 있어요.",
      body: `오늘 물을 주지 않으면 완전히 시들고 말 거예요.`,
    },
    {
      title: `${nickname}님, 괜찮으세요?`,
      body: `오랫동안 뵙지 못해서 혹시 무슨 일이 있는지 걱정돼요. 잘 지내고 계시죠?`,
    },
    {
      title: "혹시 할 일이 너무 어려우셨나요?",
      body: `조금 쉬운 할 일을 준비했으니 잠시 시간내서 찾아와주세요.`,
    },
    {
